...
- [Tugas 4](#tugas-4-1)
  - [1. Manfaat Penggunaan JavaScript dalam Pengembangan Aplikasi Web](#1-manfaat-penggunaan-javascript-dalam-pengembangan-aplikasi-web)
  - [2. Fungsi await ketika Menggunakan fetch() dan Dampaknya jika Tidak Menggunakan await](#2-fungsi-await-ketika-menggunakan-fetch-dan-dampaknya-jika-tidak-menggunakan-await)
  - [3. Mengapa Menggunakan Decorator csrf\_exempt pada View untuk AJAX POST?](#3-mengapa-menggunakan-decorator-csrf_exempt-pada-view-untuk-ajax-post)
  - [4. Mengapa Pembersihan Data Input Pengguna Dilakukan di Backend?](#4-mengapa-pembersihan-data-input-pengguna-dilakukan-di-backend)
  - [5. Langkah Implementasi Checklist (Step-by-Step)](#5-langkah-implementasi-checklist-step-by-step)
    - [a. Implementasi AJAX GET](#a-implementasi-ajax-get)
    - [b. Implementasi AJAX POST](#b-implementasi-ajax-post)
